...
param$F0 <- rep(0.1,param$nSpecies)
...
for (i in 1:nyear){
  ...
  M[i,] <- SF$M2[param$tEnd/param$dt,1,]
...
plot(years,rowMeans(M[,SF$w > 1]), type = 'l', ylab = 'natural mortality')
...
save(ls.forage, file = 
       'C:/Users/s102045/Dropbox/UW/Fluctuations paper/Multispecies model/single species model/forage_simulation.RData')
